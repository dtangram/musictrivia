      ...
      <React.Fragment>
        <div className="quizWrap">
          <section className="wrapper wrapperOne">
            ...
            <div>
              <p>
                <RRLink to="https://github.com/login/oauth/authorize?clientId=116dde797c68291268c9&scope='identity.basic,identity.email'&redirectURL=https://musictriviaquiz.herokuapp.com">Login with Github</RRLink>
                <br />
